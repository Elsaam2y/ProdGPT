...
const font = Montserrat({ weight: '600', subsets: ['vietnamese'] }); //Available subsets: `cyrillic`, `cyrillic-ext`, `latin`, `latin-ext`, `vietnamese`
    ...
    <nav className="p-4 bg-transparent flex items-center justify-between">
      ...
      <div className="flex items-center gap-x-2">
        <Link href={isSignedIn ? '/Images' : '/sign-up'}>
          ...
          <Button variant="outline" className="rounded-full shadow-md hover:bg-blue-100">
            Get Started
          </Button>
        </Link>
      </div>
